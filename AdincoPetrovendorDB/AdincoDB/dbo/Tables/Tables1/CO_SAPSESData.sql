CREATE TABLE [dbo].[CO_SAPSESData] (
    ...
    CONSTRAINT [PK_CO_SAPSESData] PRIMARY KEY CLUSTERED ([IdSAPSES] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_CO_SAPSESData]
    ON [dbo].[CO_SAPSESData]([IdContrato] ASC, [SESNumber] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
