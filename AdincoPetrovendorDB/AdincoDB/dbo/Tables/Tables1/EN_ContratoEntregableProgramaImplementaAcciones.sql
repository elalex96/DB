CREATE TABLE [dbo].[EN_ContratoEntregableProgramaImplementaAcciones] (
    ...
    [Activo]                           BIT  NULL,
    CONSTRAINT [PK_EN_ContratoEntregableProgramaImplementaAcciones] PRIMARY KEY CLUSTERED ([IdContratoEntregable] ASC, [IdProgramaImplementaAccion] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
