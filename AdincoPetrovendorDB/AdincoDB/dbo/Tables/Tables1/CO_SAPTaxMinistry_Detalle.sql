CREATE TABLE [dbo].[CO_SAPTaxMinistry_Detalle] (
    ...
    CONSTRAINT [PK_CO_SAP_TaxMinistry_Detalle] PRIMARY KEY CLUSTERED ([SAPPayType] ASC, [IdTaxMinistry] ASC, [IdContrato] ASC, [IdMetodoPagoAdinco] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
