CREATE TABLE [dbo].[CO_SAPProforma] (
    ...
    [IdSAPGR]           INT           NULL,
    [IdSAPSES]          INT           NULL,
    CONSTRAINT [PK_CO_SAPProforma] PRIMARY KEY CLUSTERED ([IdSAPProforma] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_CO_SAPProforma]
    ON [dbo].[CO_SAPProforma]([IdSAPPO] ASC, [Reference] ASC, [IdEstatus] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
