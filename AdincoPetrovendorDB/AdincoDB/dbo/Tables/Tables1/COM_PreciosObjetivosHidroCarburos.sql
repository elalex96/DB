CREATE TABLE [dbo].[COM_PreciosObjetivosHidroCarburos] (
    ...
    CONSTRAINT [PK_COM_PreciosObjetivosHidroCarburos] PRIMARY KEY CLUSTERED ([IdContrato] ASC, [Mes] ASC, [IdTipoHidrocarburo] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
