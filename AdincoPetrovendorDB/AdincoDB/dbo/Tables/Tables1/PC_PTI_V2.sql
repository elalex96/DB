CREATE TABLE [dbo].[PC_PTI_V2] (
    ...
    CONSTRAINT [PK_PC_PTI_V2] PRIMARY KEY CLUSTERED ([IdPTI] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [idx_Factura]
    ON [dbo].[PC_PTI_V2]([Factura] ASC) WITH (STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [idx_UUID]
    ON [dbo].[PC_PTI_V2]([UUID] ASC) WITH (FILLFACTOR = 85, STATISTICS_NORECOMPUTE = ON);
