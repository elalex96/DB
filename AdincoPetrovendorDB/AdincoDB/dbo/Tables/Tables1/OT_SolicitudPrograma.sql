CREATE TABLE [dbo].[OT_SolicitudPrograma] (
    ...
    [IdEstatus]             BIT             NULL,
    CONSTRAINT [PK_OT_SolicitudPrograma] PRIMARY KEY CLUSTERED ([IdOTSolicitudPrograma] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_OT_SolicitudPrograma]
    ON [dbo].[OT_SolicitudPrograma]([IdOTSolicitudMaterial] ASC, [Anio] ASC, [Mes] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
