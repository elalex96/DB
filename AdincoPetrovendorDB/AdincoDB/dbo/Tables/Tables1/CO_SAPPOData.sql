CREATE TABLE [dbo].[CO_SAPPOData] (
    ...
    CONSTRAINT [PK_CO_SAPData] PRIMARY KEY CLUSTERED ([IdSAPData] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_CO_SAPData]
    ON [dbo].[CO_SAPPOData]([IdContrato] ASC, [SAPPONumber] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
