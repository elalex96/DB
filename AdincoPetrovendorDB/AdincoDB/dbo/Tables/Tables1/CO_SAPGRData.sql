CREATE TABLE [dbo].[CO_SAPGRData] (
    ...
    CONSTRAINT [PK_CO_SAPGRData] PRIMARY KEY CLUSTERED ([IdSAPGR] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_CO_SAPGRData]
    ON [dbo].[CO_SAPGRData]([IdSAPPO] ASC, [DocumentDate] ASC, [MatDocN] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
