CREATE TABLE [dbo].[PC_PMI_V2] (
    ...
    CONSTRAINT [PK_PC_PMI_V2] PRIMARY KEY CLUSTERED ([IdPMI] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [idx_UUID]
    ON [dbo].[PC_PMI_V2]([UUID] ASC) WITH (FILLFACTOR = 85, STATISTICS_NORECOMPUTE = ON);
