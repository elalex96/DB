CREATE TABLE [dbo].[CO_ProgramaImplementaDepartamentoUsuario] (
    ...
    [Activo]                           BIT      NULL,
    CONSTRAINT [PK_CO_ProgramaImplementaDepartamentoUsuario] PRIMARY KEY CLUSTERED ([IdProgramaImplementaDepartamento] ASC, [IdUsuario] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
