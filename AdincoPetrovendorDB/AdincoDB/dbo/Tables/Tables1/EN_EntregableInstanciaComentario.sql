CREATE TABLE [dbo].[EN_EntregableInstanciaComentario] (
    ...
    [MotivoEliminacion]     NVARCHAR (MAX) NULL,
    ...
    CONSTRAINT [FK_EN_EntregableInstanciaComentario_AP_Usuario_EliminadoPor] FOREIGN KEY ([EliminadoPor]) REFERENCES [dbo].[AP_Usuario] ([UsuarioID]),
