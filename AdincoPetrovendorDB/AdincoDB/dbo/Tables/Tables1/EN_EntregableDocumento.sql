CREATE TABLE [dbo].[EN_EntregableDocumento] (
    ...
    PRIMARY KEY CLUSTERED ([DocumentoEntregableId] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
    ...
    CONSTRAINT [FK_EN_EntregableDocumento_AP_Usuario] FOREIGN KEY ([CreadoPor]) REFERENCES [dbo].[AP_Usuario] ([UsuarioID]),
