CREATE TABLE [dbo].[PC_Comercializacion_V2] (
    ...
    CONSTRAINT [PK_PC_Comercializacion_V2] PRIMARY KEY CLUSTERED ([IdComercializacion] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [idx_Factura]
    ON [dbo].[PC_Comercializacion_V2]([Factura] ASC) WITH (STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [idx_FechaReporte_Factura_FechaFactura]
    ON [dbo].[PC_Comercializacion_V2]([FechaReporte] ASC, [Factura] ASC, [FechaFactura] ASC) WITH (STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [idx_Referencia1]
    ON [dbo].[PC_Comercializacion_V2]([Referencia1] ASC) WITH (STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [idx_Nombre1]
    ON [dbo].[PC_Comercializacion_V2]([Nombre1] ASC) WITH (STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [idx_Denominacion]
    ON [dbo].[PC_Comercializacion_V2]([Denominación] ASC) WITH (STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [idx_FechaFactura]
    ON [dbo].[PC_Comercializacion_V2]([FechaFactura] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
