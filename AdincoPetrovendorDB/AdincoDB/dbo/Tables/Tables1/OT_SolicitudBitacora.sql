CREATE TABLE [dbo].[OT_SolicitudBitacora] (
    ...
    CONSTRAINT [PK_OT_SolicitudBitacora] PRIMARY KEY CLUSTERED ([IdOTBitacora] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_OT_SolicitudBitacora]
    ON [dbo].[OT_SolicitudBitacora]([IdOTSolicitud] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
