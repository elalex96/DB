CREATE TABLE [dbo].[CO_SAPGRDataDetalle] (
    ...
    CONSTRAINT [PK_CO_SAPGRDataDetalle] PRIMARY KEY CLUSTERED ([IdSAPGRDetalle] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_CO_SAPGRDataDetalle]
    ON [dbo].[CO_SAPGRDataDetalle]([IdSAPGR] ASC, [POLineNumber] ASC, [MatDocN] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
