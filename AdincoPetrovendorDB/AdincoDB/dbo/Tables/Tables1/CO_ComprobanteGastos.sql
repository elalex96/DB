CREATE TABLE [dbo].[CO_ComprobanteGastos] (
    ...
    CONSTRAINT [PK_CO_ComprobanteGastos_1] PRIMARY KEY CLUSTERED ([IdBeneficiario] ASC, [IdContrato] ASC, [IdFacturaGasto] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_CO_ComprobanteGastos]
    ON [dbo].[CO_ComprobanteGastos]([IdComprobanteGasto] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
