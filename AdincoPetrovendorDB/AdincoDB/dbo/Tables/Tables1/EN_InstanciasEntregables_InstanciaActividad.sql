CREATE TABLE [dbo].[EN_InstanciasEntregables_InstanciaActividad] (
    ...
    [Activo]                BIT      NULL,
    CONSTRAINT [PK_EN_InstanciasEntregables_InstanciaActividad] PRIMARY KEY CLUSTERED ([idInstanciaEntregable] ASC, [idInstanciaActividad] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
GO
CREATE NONCLUSTERED INDEX [IX_EN_InstanciasEntregables_InstanciaActividad]
    ON [dbo].[EN_InstanciasEntregables_InstanciaActividad]([idInstanciaEntregable] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
