CREATE TABLE [dbo].[CO_SAPSESDataDetalle] (
    ...
    CONSTRAINT [PK_CO_SAPSESDetalle] PRIMARY KEY CLUSTERED ([IdSAPSESDetalle] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_CO_SAPSESDataDetalle]
    ON [dbo].[CO_SAPSESDataDetalle]([SESLine] ASC, [IdSAPSES] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
