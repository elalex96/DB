CREATE TABLE [dbo].[AP_Aspx] (
    ...
    [Activo]        BIT            NULL,
    CONSTRAINT [PK_AP_Aspx] PRIMARY KEY CLUSTERED ([IdOpcionMenu] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON)
);
...
CREATE UNIQUE NONCLUSTERED INDEX [NonClusteredIndex-20180626-132634]
    ...
    INCLUDE([ClaveMenu]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
