CREATE TABLE [dbo].[PC_ExcelPemex] (
    ...
    [IdContrato]       INT            NULL,
    CONSTRAINT [PK_PC_ExcelPemex] PRIMARY KEY CLUSTERED ([IdExcelPemex] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [idx_IdTipoExcelPemex]
    ON [dbo].[PC_ExcelPemex]([IdTipoExcelPemex] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
