CREATE TABLE [dbo].[S_Notificacion] (
    ...
    CONSTRAINT [PK_S_Notificacion] PRIMARY KEY CLUSTERED ([IdNotificacion] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [S_Notificacion_Enviada]
    ON [dbo].[S_Notificacion]([Enviada] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
