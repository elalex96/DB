CREATE TABLE [dbo].[PC_AnalisisCromatograficoGas] (
    ...
    CONSTRAINT [PK_PC_AnalisisCromatograficoGas] PRIMARY KEY CLUSTERED ([IdAnalisisCromatograficoGas] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [idx_Contrato_MesReporte_IdPtoExpedicionRecepcion_Dia]
    ON [dbo].[PC_AnalisisCromatograficoGas]([IdContrato] ASC, [MesReporte] ASC, [IdPtoExpedicionRecepcion] ASC, [Dia] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
