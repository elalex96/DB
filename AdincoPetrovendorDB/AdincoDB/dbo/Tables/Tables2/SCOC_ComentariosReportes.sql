CREATE TABLE [dbo].[SCOC_ComentariosReportes] (
    ...
    CONSTRAINT [PK_SCOC_ComentariosReportes] PRIMARY KEY CLUSTERED ([IdContrato] ASC, [MesReporte] ASC, [ProductoNominacionID] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
