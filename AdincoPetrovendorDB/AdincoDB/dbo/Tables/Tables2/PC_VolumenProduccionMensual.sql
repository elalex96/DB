CREATE TABLE [dbo].[PC_VolumenProduccionMensual] (
    [IdReporteVolumenProduccionMensual]         INT             IDENTITY (10000, 1) NOT NULL,
    [IdContrato]                                INT             NULL,
    ...
    CONSTRAINT [PK_PC_VolumenProduccionMensual] PRIMARY KEY CLUSTERED ([IdReporteVolumenProduccionMensual] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
    CONSTRAINT [FK_PC_VolumenProduccionMensual_CO_Contrato] FOREIGN KEY ([IdContrato]) REFERENCES [dbo].[CO_Contrato] ([IdContrato])
);
