CREATE TABLE [dbo].[PC_VolumenProduccionPeriodo] (
    [IdReporteVolumenProduccionPeriodo]         INT             IDENTITY (10000, 1) NOT NULL,
    [IdContrato]                                INT             NULL,
    ...
    [VolumenGasMMPC]                            FLOAT (53)      NULL,
    CONSTRAINT [PK_PC_VolumenProduccionPeriodo] PRIMARY KEY CLUSTERED ([IdReporteVolumenProduccionPeriodo] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
    CONSTRAINT [FK_PC_VolumenProduccionPeriodo_CO_Contrato] FOREIGN KEY ([IdContrato]) REFERENCES [dbo].[CO_Contrato] ([IdContrato])
);
