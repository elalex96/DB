CREATE TABLE [dbo].[PC_VolumenComercializacionMensual] (
    [IdReporteVolumenComercializacionMensual]   INT             IDENTITY (10000, 1) NOT NULL,
    [IdContrato]                                INT             NULL,
    ...
    CONSTRAINT [PK_PC_VolumenComercializacionMensual] PRIMARY KEY CLUSTERED ([IdReporteVolumenComercializacionMensual] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
    CONSTRAINT [FK_PC_VolumenComercializacionMensual_CO_Contrato] FOREIGN KEY ([IdContrato]) REFERENCES [dbo].[CO_Contrato] ([IdContrato])
);
