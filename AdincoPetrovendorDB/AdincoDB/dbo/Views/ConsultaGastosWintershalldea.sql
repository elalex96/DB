...
CREATE VIEW [dbo].[ConsultaGastosWintershalldea]
AS
     ...
     FROM dbo.CO_LineaPresupuestoMes LPM(NOLOCK)
          ...
          JOIN dbo.CO_Instalacion I(NOLOCK) ON LPM.IdInstalacion = I.IdInstalacion
