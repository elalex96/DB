CREATE VIEW dbo.VistaRegistrosGastosMiahuapan
AS
...
WHERE        (dbo.CO_Presupuesto.IdPresupuesto = 2) AND (dbo.CO_Registro.IdRegistro IS NOT NULL)
      ...
      Begin Tables = 
         ...
         Begin Table = "InstalacionRegistro"
            Begin Extent = 
               ...
               Left = 38
               Bottom = 400
               Right = 28', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosMiahuapan';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'3
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosMiahuapan';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosMiahuapan';
