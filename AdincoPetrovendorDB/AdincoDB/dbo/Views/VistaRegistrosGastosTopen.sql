CREATE VIEW dbo.VistaRegistrosGastosTopen
AS
...
WHERE        (dbo.CO_Presupuesto.IdPresupuesto = 10023) AND (dbo.CO_Registro.IdRegistro IS NOT NULL)
      ...
      Begin Tables = 
         ...
         Begin Table = "InstalacionRegistro"
            Begin Extent = 
               ...
               Left = 38
               Bottom = 400
               Right = ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosTopen';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'283
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosTopen';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosTopen';
