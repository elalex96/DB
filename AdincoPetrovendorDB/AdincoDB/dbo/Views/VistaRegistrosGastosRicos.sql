CREATE VIEW dbo.VistaRegistrosGastosRicos
AS
SELECT        TOP (100) PERCENT dbo.CO_Servicio.NombreServicio AS Servicio, dbo.CO_Instalacion.NombreInstalacion AS InstalacionPresupuestada, dbo.CO_LineaPresupuestoMes.AC_FEC_INI AS FechaInicio, 
                         ...
                         dbo.CO_LineaPresupuestoMes.IdLineaPresupuestoMes AS LineaPresupuesto, dbo.CO_Presupuesto.Nombre AS Presupuesto, dbo.CO_ActividadPetroleraCNH.id_Actividad, 
                         dbo.CO_ActividadPetroleraCNH.DescripcionActividadPetrolera, dbo.CO_SubactividadPetrolera.[id_Sub-actividad], dbo.CO_SubactividadPetrolera.SubactividadPetrolera, 
                         dbo.CO_TareaPetrolera.TareaPetrolera
FROM            dbo.CO_Servicio RIGHT OUTER JOIN
                         dbo.CO_LineaPresupuestoMes INNER JOIN
                         dbo.CO_ActividadPetroleraCNH ON dbo.CO_LineaPresupuestoMes.IdActividadPetrolera = dbo.CO_ActividadPetroleraCNH.IdActividadPetrolera INNER JOIN
                         dbo.CO_SubactividadPetrolera ON dbo.CO_LineaPresupuestoMes.IdSubactividadPetrolera = dbo.CO_SubactividadPetrolera.IdSubactividadPetrolera INNER JOIN
                         dbo.CO_TareaPetrolera ON dbo.CO_LineaPresupuestoMes.IdTareaPetrolera = dbo.CO_TareaPetrolera.IdTareaPetrolera ON 
                         dbo.CO_Servicio.IdServicio = dbo.CO_LineaPresupuestoMes.IdServicio LEFT OUTER JOIN
...
WHERE        (dbo.CO_Presupuesto.IdPresupuesto IN (10034, 10035)) AND (dbo.CO_Registro.IdRegistro IS NOT NULL)
GROUP BY dbo.CO_Servicio.NombreServicio, dbo.CO_Instalacion.NombreInstalacion, dbo.CO_LineaPresupuestoMes.AC_FEC_INI, dbo.CO_LineaPresupuestoMes.AC_FEC_FIN, dbo.FI_Factura.Fecha, 
                         ...
                         dbo.CO_LineaPresupuestoMes.IdLineaPresupuestoMes, InstalacionRegistro.IdInstalacion, dbo.CO_Presupuesto.Nombre, dbo.CO_Registro.Fila, dbo.CO_ActividadPetroleraCNH.id_Actividad, 
                         dbo.CO_ActividadPetroleraCNH.DescripcionActividadPetrolera, dbo.CO_SubactividadPetrolera.[id_Sub-actividad], dbo.CO_SubactividadPetrolera.SubactividadPetrolera, 
                         dbo.CO_TareaPetrolera.TareaPetrolera
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "CO_LineaPresupuestoMes"
            ...
            TopColumn = 0
         End
         Begin Table = "CO_ActividadPetroleraCNH"
            Begin Extent = 
               Top = 6
               Left = 571
               Bottom = 136
            ...
            TopColumn = 0
         End
         Begin Table = "CO_SubactividadPetrolera"
            Begin Extent = 
               Top = 138
               Left = 38
               Bottom = 268
         ...
         Begin Table = "CO_Registro"
            Begin Extent = 
               ...
               Left = 38
               Bottom = 400
    ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosRicos';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'           Right = 285
            End
            DisplayFlags = 280
            TopColumn = 0
         End
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 3, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosRicos';
