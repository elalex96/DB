CREATE VIEW dbo.VistaRegistrosGastosAmatitlan
AS
...
WHERE        (dbo.CO_Presupuesto.IdPresupuesto = 10000) AND (dbo.CO_Registro.IdRegistro IS NOT NULL)
      ...
      Begin Tables = 
         ...
         Begin Table = "InstalacionRegistro"
            Begin Extent = 
               ...
               Left = 38
               Bottom = 400
               Right = ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosAmatitlan';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'283
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosAmatitlan';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaRegistrosGastosAmatitlan';
