CREATE PROCEDURE [dbo].[SP_ValidarContratoImportacionEntregables] --10103,10152
...
BEGIN
	...
	IF @IdContrato IN (10101,10103,10104,10106,10107,10112,10113,10115,10118,10131,10151, 10152) --SHELL
	BEGIN
