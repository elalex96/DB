CREATE PROCEDURE [dbo].[sp_SIPAC_ReporteTarjetaDebito_RCCONT09M]
...
AS
     BEGIN
         ...
         FROM FI_Transfer tr WITH(NOLOCK)
              ...
              LEFT JOIN ap_lista li ON tr.IdClasificacionDocumento = li.idclave
         ...
         GROUP BY con.IdSipac, 
                  ...
                  li.IdClave;
         --EXEC sp_SIPAC_ReporteTarjetaDebito_RCCONT09M 3,'2017-03-01',3
