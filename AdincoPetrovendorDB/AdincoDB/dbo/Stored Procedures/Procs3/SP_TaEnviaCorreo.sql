...
-- Description:	
-- =============================================
CREATE PROCEDURE [dbo].[SP_TaEnviaCorreo]
...
BEGIN
	...
	declare @nombreremitente nvarchar(MAX) = (select nombre from AP_Usuario where UsuarioID = @idusuario)
	...
	declare @idcorreoservidor int = (select IdCorreoServidor from S_CorreoServidor)
