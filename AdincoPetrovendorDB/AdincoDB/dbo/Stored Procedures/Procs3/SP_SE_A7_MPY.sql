...
AS
    BEGIN
		...
		DECLARE
            ...
            @InfraestructuraFisicaLocalRegional   INT = 6,
            ...
            (
                ...
                IdFactura
                    ...
                    SELECT
                        ...
                        SUM(PV.ValorFactura)             AS SubTotal,
                        FA.IdFactura
                    FROM
                        #FacturasAdinco                                    FA
                        JOIN
                        ...
                        JOIN
                            Petrovendor.dbo.MPY_MM_AceptacionPedidoDetalle APD  (NOLOCK)
								...
								AND	APD.ClasificacionCN = @InfraestructuraFisicaLocalRegional --Infraestructura Fisica Local y Regional
                        LEFT JOIN
                            Petrovendor.dbo.MPY_MM_PCN_ValoresPesos        PV  (NOLOCK)
                                ON APD.IdAceptacionPedidoDetalle = PV.IdAceptacionPedidoDetalle
                    WHERE
                        APD.ClasificacionCN = @InfraestructuraFisicaLocalRegional --Infraestructura Fisica Local y Regional
                    GROUP BY
                        APD.DESCRIPCIONCORTA,
                        FA.IdFactura;
        ...
        INSERT INTO #DATOS
            (
                ...
                IdFactura
					 ...
					 JOIN
                            dbo.CO_Registro              R (NOLOCK)
                                ON FA.IdFactura	=	R.IdFactura
								   ...
								   AND R.IdGastoRubro = @InfraestructuraFisicaLocalRegional --Infraestructura Fisica Local y Regional
                        JOIN
                    ...
                    WHERE
                        R.IdGastoRubro = @InfraestructuraFisicaLocalRegional --Infraestructura Fisica Local y Regional
                        AND S.RFC NOT IN (
                                             SELECT
                                                 RFC
                                             FROM
