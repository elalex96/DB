IF OBJECT_ID('dbo.USP_SEL_CO_HistorialBitacoraPresupuesto', 'P') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.USP_SEL_CO_HistorialBitacoraPresupuesto;
END
GO
...
BEGIN
    ...
    SELECT 
        ...
        CASE 
            WHEN b.IdLineaPresupuestoAnterior IS NULL THEN NULL
            ELSE CAST(b.IdLineaPresupuestoAnterior AS NVARCHAR(50))
        END AS LineaPresupuestoAnterior,

        CASE 
            WHEN b.IdLineaPresupuestoNuevo IS NULL THEN NULL
            ELSE CAST(b.IdLineaPresupuestoNuevo AS NVARCHAR(50))
