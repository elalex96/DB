     ...
     BEGIN
         ...
         (IdFactura, 
          ...
          FechaDePago
                ...
                SELECT dbo.FI_ComplementoDePago.IdFactura, 
                ...
                FROM dbo.FI_FacturaContrato (NOLOCK)
                     JOIN dbo.FI_Factura  (NOLOCK) ON  dbo.FI_FacturaContrato.IdFactura = dbo.FI_Factura.IdFactura
                     JOIN dbo.FI_CPDocRelacionado  (NOLOCK) ON dbo.FI_Factura.UUID = dbo.FI_CPDocRelacionado.IdDocumento 
                     JOIN dbo.FI_ComplementoDePago  (NOLOCK) ON dbo.FI_CPDocRelacionado.IdComplementoDePago = dbo.FI_ComplementoDePago.IdComplementoDePago 
                WHERE dbo.FI_FacturaContrato.IdContrato = @IdContrato
                GROUP BY dbo.FI_ComplementoDePago.IdFactura, 
                       dbo.FI_ComplementoDePago.FormaDePagoP, 
                       dbo.FI_ComplementoDePago.MonedaP, 
                       dbo.FI_ComplementoDePago.Monto, 
                       dbo.FI_ComplementoDePago.FechaDePago;
            ...
            AND @IdAccion = 0)
             BEGIN
                 ...
                 FROM dbo.FI_ComplementoDePago (NOLOCK)
                      JOIN dbo.FI_Factura (NOLOCK) ON dbo.FI_ComplementoDePago.IdFactura = dbo.FI_Factura.IdFactura
                      JOIN dbo.CO_Contrato (NOLOCK) ON dbo.FI_Factura.IdContrato = dbo.CO_Contrato.IdContrato 
                      JOIN dbo.PV_Subcontratista (NOLOCK) ON dbo.FI_Factura.IdSubcontratista = dbo.PV_Subcontratista.IdSubcontratista
                      LEFT JOIN dbo.FI_TransferFactura (NOLOCK) ON dbo.FI_Factura.IdFactura = dbo.FI_TransferFactura.IdFactura
                      LEFT JOIN dbo.FI_Transfer (NOLOCK) ON dbo.FI_TransferFactura.IdTransfer = dbo.FI_Transfer.IdTransferencia
                 WHERE dbo.FI_Factura.IdSubcontratista = @IdProveedor
                 ...
                 GROUP BY SUBSTRING(dbo.PV_Subcontratista.RazonSocial, 0, 30), 
                 ...
                 FROM dbo.FI_Factura (NOLOCK)
                      JOIN dbo.CO_Contrato (NOLOCK) ON dbo.FI_Factura.IdContrato = dbo.CO_Contrato.IdContrato 
                      JOIN #IdFacturaComplemento (NOLOCK) ON  dbo.FI_Factura.IdFactura  = #IdFacturaComplemento.IdFactura
					  JOIN dbo.PV_Subcontratista (NOLOCK) ON dbo.FI_Factura.IdSubcontratista = dbo.PV_Subcontratista.IdSubcontratista
                      LEFT JOIN dbo.FI_TransferFactura (NOLOCK) ON dbo.FI_Factura.IdFactura = dbo.FI_TransferFactura.IdFactura
                      LEFT JOIN dbo.FI_Transfer (NOLOCK) ON dbo.FI_TransferFactura.IdTransfer = dbo.FI_Transfer.IdTransferencia
                 WHERE dbo.FI_Factura.IdSubcontratista = @IdProveedor
                 ...
                 GROUP BY SUBSTRING(dbo.PV_Subcontratista.RazonSocial, 0, 30), 
                          ...
                          dbo.FI_Factura.Emisor, 
                          #IdFacturaComplemento.Moneda
                 ORDER BY dbo.FI_Factura.IdFactura DESC;
             END;
         IF(@IdTransferFacPago <> 0
            AND @IdAccion <> 0)
             BEGIN
