/****** Object:  StoredProcedure [dbo].[sp_Pr_InsertaProduccionPetroleoConBalance]    Script Date: 07/02/2019 02:10:07 p. m. ******/
-- =============================================
-- Author:		Reyna Olvera
-- Create date: 20180904
-- Description:	Inserta Produccion de Reporte diario
-- =============================================
CREATE PROCEDURE [dbo].[sp_Pr_InsertaProduccionPetroleoConBalance] --10010,10061,'20180901','CNH-M1-EK-BALAM/2017','MMPC','20°','CampoPrueba','20180902','20180902',5,4668.18,18.50,7688.00,3.63,0.9404,0.9404,2
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                VALUES
                (@IdContratoArchivo, @Mes, @FechaReporte, @FechaEntrega, @Dia, @M3_20Grados, @M3_15Grados, @gradosApi,
                 @aguasedimento, @sal, @azufre, @Peso_ESPEC, @IdUnidadMedida, @idUsuario, GETDATE(), @idUsuario,
                 GETDATE(), @CampoID, @Temp);
            END;
            ELSE
            BEGIN
                SET @pError
