USE [Petrovendor]
GO
/****** Object:  StoredProcedure [dbo].[sp_JOB_CreaVistaPedidosJaguar]    Script Date: 21/09/2021 02:00:07 p. m. ******/
SET ANSI_NULLS ON
GO
...
JOIN  
	...
	AND P.IdProveedorCompras IN (606, 690,676, 1315, 2766, 2958, 1835, 863, 907)-- JAGUAR, CARDENAS-MORA, OGARRIO
JOIN   
...
WHERE  
	P.IdProveedorCompras IN (606, 690,676, 1315, 2766, 2958, 1835, 863, 907)-- JAGUAR, CARDENAS-MORA, OGARRIO
GROUP BY  
	C.IdContrato,  
	C.NumeroContrato,  
	P.IdPedido,  
...
JOIN  
	...
	AND PG.IdProveedorCliente IN (606, 690,676, 1315, 2766, 2958, 1835, 863, 907)
...
JOIN	Adinco.dbo.CO_ActividadCIEP AS ACIEP
	ON LPM.IdActividad = ACIEP.IdActividad
JOIN dbo.CO_RubroInterno RI(NOLOCK) 
...
WHERE TAO.IdEstatusOperacion = 2 AND ff2.Receptor IN('JEP1709042B1', 'PEP170906DI5', 'JSE1601292U8','JEP1502264H1','JEP170904B1','JEP-170904-2B1')
