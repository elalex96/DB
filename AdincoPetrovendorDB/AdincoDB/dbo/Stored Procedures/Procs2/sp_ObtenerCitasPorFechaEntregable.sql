CREATE PROCEDURE [dbo].[sp_ObtenerCitasPorFechaEntregable]
		@IdContratoEntregable as int,
...
SELECT 		
		...
		, '' RecordatorioInfo
		, '' ReaparicionInfo
  FROM  EN_Entregable E INNER JOIN EN_ContratoEntregable CE ON E.IdEntregable = CE.IdEntregable		
