CREATE PROCEDURE dbo.sp_EN_NotificacionesSemanales_ShellAnticipadas
AS
BEGIN
-- =============================================
...
SELECT @HOY = DATEADD(DAY, 8 - DiaDeSemana, idfecha)
FROM AP_Calendario
...
--		Destinatario,						-- Para
		'joshua.gamboa@shell.com; khiani.peredo@shell.com; carmen.martinez@shell.com;',
		CASE 
