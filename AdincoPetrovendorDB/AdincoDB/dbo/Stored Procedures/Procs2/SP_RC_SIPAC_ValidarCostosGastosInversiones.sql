...
--              Reporte de Costos, Gastos e Inversiones,   
...
-- =============================================  
-- Alter Author:        MNGA   
-- Alter Date:          27-01-202   
-- Alter Description:   Agregar Alertas Con Respecto a el presupuesto  
-- =============================================  
-- Alter Author:        Pedro Acuna  
-- Alter Date:          23-oct-2020  
-- Alter Description:   Se agrega alerta cuando el periodo entra a los 6 meses permitidos a su fecha de finalizacion  
-- =============================================  
-- Author:              Manuel Cruz  
-- Create date:         04-01-2023  
-- Description:         Se ajusta validación para regresar los datos correspondientes al presupuesto enviado como parámetro  
-- =============================================  
...
BEGIN  
 ...
 DECLARE @Reporte INT;  
    ...
    EXEC dbo.SIPAC_RC_CONT_22_M @Contrato, @Mes, @IdPresupuesto, @Plantilla;  
