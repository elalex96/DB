...
AS
     BEGIN
         ...
         SELECT NoCapacitacion, 
                ...
                RazonSocial, 
                RFC, 
                CAST(SUM(SubTotal) AS DECIMAL(20, 2)) AS SubTotal, 
                CAST(SUM(PCN) / COUNT(IdFactura) AS DECIMAL(20, 3)) AS PCN, 
                CAST(CAST(SUM(SubTotal) AS DECIMAL(20, 2)) * CAST(SUM(PCN) / COUNT(IdFactura) AS DECIMAL(20, 3)) AS DECIMAL(20, 2)) AS CN, 
                IdFactura
         FROM #DATOS
