USE [Petrovendor]
GO
/****** Object:  StoredProcedure [dbo].[SP_MM_WDEA_CotizacionAutomatico_WDEA]    Script Date: 10/09/2021 09:55:54 a. m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	DECLARE @IdOperacion INT,
		...
		@IdUsuario INT = (SELECT TOP 1 IdUsuario FROM S_Usuario WHERE Correo = 'admin@adinco.mx' AND Activo = 1), 
	...
	BEGIN
		...
		SET @MENSAJEFINAL = 'ERROR AL PROCESAR EL PURCHASING_DOCUMENT ' + @Purchasing + ' EN LA COTIZACION DE PROCURA, FALTO DE PROCESAR EL PEDIDO.';
