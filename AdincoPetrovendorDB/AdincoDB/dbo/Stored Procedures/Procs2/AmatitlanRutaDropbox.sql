CREATE PROCEDURE AmatitlanRutaDropbox @IdFactura int
AS 
BEGIN
...
select CONCAT(ISNULL(@Ruta, 'Null'),'\', ISNULL(@Informe, 'Null'),'\', '01 Soportes','\', ISNULL(@RazonSocial, 'Null'),'\',  ISNULL(@Serie, 'Null')) as Ruta
