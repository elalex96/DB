...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'SIPAC_RC_CONT_22_MConciliacion'
)
    DROP PROCEDURE SIPAC_RC_CONT_22_MConciliacion;
GO

CREATE PROCEDURE [dbo].[SIPAC_RC_CONT_22_MConciliacion]  
    @Contrato      INT,   
    @IdPresupuesto INT          = 0,  
