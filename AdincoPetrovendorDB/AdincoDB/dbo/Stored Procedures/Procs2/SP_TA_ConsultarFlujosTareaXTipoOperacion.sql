USE [Petrovendor]
GO
/****** Object:  StoredProcedure [dbo].[SP_TA_ConsultarFlujosTareaXTipoOperacion]    Script Date: 26/11/2021 01:47:14 p. m. ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
	ALTER  PROCEDURE [dbo].[SP_TA_ConsultarFlujosTareaXTipoOperacion] 
