...
--====================================
CREATE PROCEDURE [dbo].[SP_CO_InformeRevGast_TotalAprobados_InformeRevisionGastos]
    @IdPresupuesto   INT,
...
AS
    BEGIN
        ...
        DECLARE @Fecha VARCHAR(150)='',@FechaRevGastosElegibles VARCHAR(150) = '',@FechaGastosPendientesReconocer VARCHAR(150)='',@FechaInformeContableGastos VARCHAR(200)='',@Presupuesto VARCHAR(150)=''
