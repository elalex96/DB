CREATE PROCEDURE [dbo].[SP_CO_RptGastoBase_RM] 
...
(IdRegistro               INT,
 ...
 SubTareaPetrolera        NVARCHAR(MAX),
...
(Clasificacion,
 ...
 PresupuestoUSD
                ...
                WHERE(CO_LineaPresupuestoMes.IdPresupuesto IN (10061, 10101) )
...
(IdRegistro,
 ...
 OCAprobadas
                ...
                SELECT ISNULL(R.IdRegistro, 0) AS IdRegistro,
                       ...
                       S.NombreServicio AS SubTareaPetrolera,
                ...
                WHERE P.IdPresupuesto   IN (10061, 10101)
...
(id,
 ...
 Requisitor
                ...
                WHERE lpm.IdPresupuesto  IN (10061, 10101)
...
/*SELECT LEN(Servicio), 
         ...
         SELECT #RptGastos.IdRegistro, 
			 ...
			 CONCAT('',#RptGastos.SubTareaPetrolera) AS SubTareaPetrolera,
