CREATE PROCEDURE dbo.SP_PC_SIPAC_VolumenesPreciosAsociados
	@Contrato INT,
	@Mes      DATE
AS
     BEGIN
...
IF @Contrato = 10054
BEGIN
	EXEC SP_PC_SIPAC_VolumenesPreciosAsociados_ENI @Contrato, @Mes
	RETURN
END
...
IF 0 <(SELECT COUNT(1)
	...
	BEGIN
		...
		SELECT
		    ...
		    PrecioPropano_RMPCT32_25,
		    PrecioButano_RMPCT32_26,
		    'NA'	AS	PrecioCondensado_RMPCT32_27,
		    VolPetroContratistaReparticion_RMPCT32_28,
		    VolMetanoContratistaReparticion_RMPCT32_29,
		    VolEtanoContratistaReparticion_RMPCT32_30,
		    VolPropanoContratistaReparticion_RMPCT32_31,
