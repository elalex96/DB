 ...
 PA_170,
       ...
       PA_274,
        ...
        PA_139,
               ...
               + ISNULL(PA_257, 0) + ISNULL(PA_258, 0) + ISNULL(PA_259, 0) + ISNULL(PA_260, 0) + ISNULL(PA_261, 0)
               + ISNULL(PA_262, 0) + ISNULL(PA_263, 0) + ISNULL(PA_264, 0) + ISNULL(PA_265, 0) + ISNULL(PA_266, 0)
               + ISNULL(PA_267, 0) + ISNULL(PA_268, 0) + ISNULL(PA_269, 0) + ISNULL(PA_270, 0) + ISNULL(PA_271, 0)
               + ISNULL(PA_272, 0) + ISNULL(PA_273, 0) + ISNULL(PA_274, 0) + ISNULL(PA_275, 0) + ISNULL(PA_276, 0)
               + ISNULL(PA_277, 0) + ISNULL(PA_278, 0) + ISNULL(PA_279, 0) + ISNULL(PA_280, 0) + ISNULL(PA_281, 0)
               + ISNULL(PA_282, 0) + ISNULL(PA_283, 0) + ISNULL(PA_284, 0) + ISNULL(PA_285, 0) + ISNULL(PA_286, 0)
               + ISNULL(PA_287, 0) + ISNULL(PA_288, 0) + ISNULL(PA_289, 0) + ISNULL(PA_290, 0) + ISNULL(PA_291, 0)
               + ISNULL(PA_292, 0) + ISNULL(PA_293, 0) + ISNULL(PA_294, 0) + ISNULL(PA_295, 0) + ISNULL(PA_296, 0)
               + ISNULL(PA_297, 0) + ISNULL(PA_298, 0) + ISNULL(PA_299, 0) + ISNULL(PA_300, 0) + ISNULL(PA_301, 0)
               + ISNULL(PA_302, 0) + ISNULL(PA_303, 0) + ISNULL(PA_304, 0),
			   NumeroRenglon
        FROM @Table_CO_Type_BitacoraPresupuestoDetalle;
