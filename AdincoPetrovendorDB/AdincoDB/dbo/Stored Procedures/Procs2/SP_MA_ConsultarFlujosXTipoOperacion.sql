...
-- Description:	Insertar información del flujo de aprobación por tipo de operación 
-- =============================================
CREATE PROCEDURE [dbo].[SP_MA_ConsultarFlujosXTipoOperacion]
...
BEGIN
    SET NOCOUNT ON;
			...
			WHERE TOF.IdTipoOperacion=@IdTipoOperacion AND F.IdContrato=@IdContrato
END; 
