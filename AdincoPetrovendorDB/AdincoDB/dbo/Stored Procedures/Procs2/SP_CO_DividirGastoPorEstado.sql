CREATE PROCEDURE [dbo].[SP_CO_DividirGastoPorEstado] 
	...
	BEGIN
		...
		END
			...
			SELECT IdRegistro, IdFactura, MontoRegistro, CreadoPor, (MontoRegistro * @Porcentaje) / 100 FROM RespaldoRegistro WHERE IdFactura = @IdFactura
