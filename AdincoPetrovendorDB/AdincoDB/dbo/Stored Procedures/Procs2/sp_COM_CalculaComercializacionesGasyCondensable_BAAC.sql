CREATE PROCEDURE dbo.sp_COM_CalculaComercializacionesGasyCondensable_BAAC
    @IdContrato INT,
    @MesReporte    DATE,
	@Usuario	INT,
...
--IF @Debug = 1
--BEGIN
--SELECT * FROM #Comercializaciones WHERE IdFactura = 180149
--END
...
--IF @Debug = 1
--BEGIN
--SELECT * FROM #PreciosGas WHERE IdFactura = 180149
--END
