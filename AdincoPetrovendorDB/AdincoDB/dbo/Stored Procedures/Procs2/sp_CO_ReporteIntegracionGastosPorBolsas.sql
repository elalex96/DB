CREATE PROCEDURE [dbo].[sp_CO_ReporteIntegracionGastosPorBolsas]
...
AS
     BEGIN
         ...
         FROM CO_LineaPresupuestoMes LP
              ...
              LEFT JOIN CO_TipoServicio TP ON LP.IdTipoServicio = TP.IdTipoServicio
              LEFT JOIN CO_ActividadCIEP A ON LP.IdActividad = A.IdActividad
              LEFT JOIN CO_Instalacion IR ON R.IdInstalacion = IR.IdInstalacion
