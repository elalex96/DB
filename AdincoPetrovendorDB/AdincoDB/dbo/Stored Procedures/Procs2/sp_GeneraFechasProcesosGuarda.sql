...
-- Description:  Se recibe como parámetro de NoRecalculo
-- =============================================
    ...
    BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          INSERT	INTO EN_InstanciasProcesosFecha	(IdProceso,Descripcion,Fecha,FechaInicial,idContrato,CreadoPor,CreadoEl,Activo,NoRecalculo)
            SELECT	@idProceso,
