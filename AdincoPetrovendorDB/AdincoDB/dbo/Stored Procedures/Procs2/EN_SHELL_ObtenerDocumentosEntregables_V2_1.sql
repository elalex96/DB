USE [Adinco]
GO
/****** Object:  StoredProcedure [dbo].[EN_SHELL_ObtenerDocumentosEntregables_V2]    Script Date: 04/02/2022 08:28:52 a. m. ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[EN_SHELL_ObtenerDocumentosEntregables_V2] --[EN_SHELL_ObtenerDocumentosEntregables_V2]3,0,2,18,1,0,0,0
...
BEGIN
	...
	SELECT
		...
		ISNULL((SELECT Nivel FROM EN_SecuenciaCarpetas WHERE Ruta = CF.RutaAnterior),(CF.Nivel - 1)) AS NivelAnterior,
		ISNULL((SELECT IsCarpetaUsuario FROM EN_SecuenciaCarpetas WHERE Ruta = CF.RutaAnterior),0) AS IsCarpetaUsuarioAnterior,
		CF.RutaAnterior,
		(SELECT Ruta FROM EN_SecuenciaCarpetas WHERE Ruta = CF.RutaAnterior) as RutaAnterior,
		CASE
