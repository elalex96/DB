...
IF EXISTS
    (
        ...
        FROM
            dbo.sysobjects
        WHERE
            name = 'sp_CO_ReporteGastosNivelActividad'
    )
    DROP PROCEDURE sp_CO_ReporteGastosNivelActividad
GO
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- =============================================  
-- Author:        Miguel  
    ...
    BEGIN
        ...
        INSERT INTO #Gastos
                    ...
                    FROM
                        ...
                        LEFT OUTER JOIN
                            dbo.FI_PedimentoComprobante (NOLOCK)
                                ON CO_Registro.IdPedimentoComprobante = FI_PedimentoComprobante.IdPedimentoComprobante
                        LEFT OUTER JOIN
                            dbo.CO_TipoCambioMensual CO_TipoCambioMensualPC (NOLOCK)
        ...
        FROM
            TempReporteGastosNivelActividad RGNA (NOLOCK);
    END;
