...
-- Description:	Envio de correos a elaboradores, revisores y aprobadores de los entregables pendientes y proximos (7 días) DE SASISOPA SOLAMENTE
-- =============================================
...
DECLARE
    ...
    WHERE
		cita.NombreContratista LIKE '%Wintershall%'
		AND E.BITINTERNO = 1	-- SOLO SASISOPA
	ORDER BY
		C.NumeroContrato,
