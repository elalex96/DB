USE [Petrovendor]
GO
/****** Object:  StoredProcedure [dbo].[MM_SP_EnvioDeGastoCompraDirectaAdinco]    Script Date: 05/08/2022 05:16:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[MM_SP_EnvioDeGastoCompraDirectaAdinco]
@idFacturaP INT,
@IdFacturaAdinco INT,
/*--------------------parametros contrato  --------------------*/
@IdContrato INT = NULL,
