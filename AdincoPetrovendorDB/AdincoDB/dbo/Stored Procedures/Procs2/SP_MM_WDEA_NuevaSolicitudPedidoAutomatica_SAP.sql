USE [Petrovendor]
GO
/****** Object:  StoredProcedure [dbo].[SP_MM_WDEA_NuevaSolicitudPedidoAutomatica_SAP]    Script Date: 10/09/2021 08:43:42 a. m. ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO [dbo].[MM_SolicitudPedido]
	...
	BEGIN
		...
		SET @MENSAJEFINAL = 'ERROR AL PROCESAR EL PURCHASING_DOCUMENT ' + @Purchasing + ' EN LA SOLICITUD DE PEDIDO DE PROCURA';
