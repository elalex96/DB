/****** Object:  StoredProcedure [dbo].[sp_SCOC_ExtraeDatosHasSHAPetroleo]    Script Date: 09/02/2019 03:34:40 p. m. ******/
-- =============================================
-- Author:		Reyna Olvera
-- Create date: 20180904
-- Description:	extrae datos del hassha
-- =============================================
CREATE PROCEDURE [dbo].[sp_SCOC_ExtraeDatosHasSHAPetroleo] --10040,2,'2019-01-01'
    @idContrato  INT,
    @idUsuario   INT,
    @MesResporte DATE
AS
    BEGIN
        ...
        FROM
                dbo.SCOC_ReporteDiarioPetroleo en
            LEFT JOIN
