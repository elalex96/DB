create PROCEDURE [dbo].[SP_PC_SIPAC_VolumenesPreciosAsociados_NuevoPrecio]
-- =============================================
-- Author:		Manuel Cruz
...
AS
     BEGIN
         ...
         (tipohidrocarburo,
          ...
          Precio
                ...
                SELECT TH.tipohidrocarburo,
					   ...
					   SUM((OP.NuevoPrecioVentaUnitario - OP.CostoUnitarioComercializacion) * ROUND(OP.VolumenVendido, 0) / VC.VolumenComercializado)
                FROM COM_OperacionComercializacion AS OP
                     LEFT JOIN CO_TipoHidrocarburo AS TH ON OP.IdTipoHidrocarburo = TH.Idtipohidrocarburo
         ...
         SELECT Ca.IDSIPAC AS RF_00,
                ...
                CONVERT(INT, VMPPG.VolumenPetroleoPuntoMedicion) AS RMPCT32_02,
                ...
                CONVERT(INT, VMPPG.MetanoC1) AS RMPCT32_06,
                CONVERT(INT, VMPPG.EtanoC2) AS RMPCT32_07,
                CONVERT(INT, VMPPG.PropanoC3) AS RMPCT32_08,
                CONVERT(INT, VMPPG.ButanoC4) AS RMPCT32_09,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.MetanoC1 - FMP53.CompensacionVolNuevoSaldoAcumuladoContratistaC1) * FMP53.NuevaDistribucionProvisionalContratista / 100), 0)
                END AS RMPCT32_29,
                ...
                CASE
                    ...
                    THEN ROUND((((VMPPG.EtanoC2 + FMP53.CompensacionVolNuevoSaldoAcumuladoContratistaC2) * FMP53.NuevaDistribucionProvisionalContratista / 100)), 0)
                    ELSE ROUND(((VMPPG.EtanoC2 - FMP53.CompensacionVolNuevoSaldoAcumuladoContratistaC2) * FMP53.NuevaDistribucionProvisionalContratista / 100), 0)
                END AS RMPCT32_30,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.PropanoC3 - FMP53.CompensacionVolNuevoSaldoAcumuladoContratistaC3) * FMP53.NuevaDistribucionProvisionalContratista / 100), 0)
                END AS RMPCT32_31,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.ButanoC4 - FMP53.CompensacionVolNuevoSaldoAcumuladoContratistaC4) * FMP53.NuevaDistribucionProvisionalContratista / 100), 0)
                END AS RMPCT32_32,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.VolumenCondensadoPuntoMedicion - FMP53.CompensacionVolNuevoSaldoAcumuladoContratistaCondensado) * FMP53.NuevaDistribucionProvisionalContratista / 100), 0)
                END AS RMPCT32_33,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.VolumenPetroleoPuntoMedicion - FMP53.CompensacionVolNuevoSaldoAcumuladoEstadoPetroleo) * FMP53.NuevaDistribucionProvisionalEstado / 100), 0)
                END AS RMPCT32_34,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.MetanoC1 - FMP53.CompensacionVolNuevoSaldoAcumuladoEstadoC1) * FMP53.NuevaDistribucionProvisionalEstado / 100), 0)
                END AS RMPCT32_35,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.EtanoC2 - FMP53.CompensacionVolNuevoSaldoAcumuladoEstadoC2) * FMP53.NuevaDistribucionProvisionalEstado / 100), 0)
                END AS RMPCT32_36,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.PropanoC3 - FMP53.CompensacionVolNuevoSaldoAcumuladoEstadoC3) * FMP53.NuevaDistribucionProvisionalEstado / 100), 0)
                END AS RMPCT32_37,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.ButanoC4 - FMP53.CompensacionVolNuevoSaldoAcumuladoEstadoC4) * FMP53.NuevaDistribucionProvisionalEstado / 100), 0)
                END AS RMPCT32_38,
                ...
                CASE
                    ...
                    ELSE ROUND(((VMPPG.VolumenCondensadoPuntoMedicion - FMP53.CompensacionVolNuevoSaldoAcumuladoContratistaCondensado) * FMP53.NuevaDistribucionProvisionalEstado / 100), 0)
                END AS RMPCT32_39,
