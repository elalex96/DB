...
AS
    BEGIN
        ...
        SELECT DISTINCT
            ...
            CASE
                WHEN FI_TransferFactura.CvTipoDocFacturacion = 1
                     AND FI_Transfer.IdFormaPago = 1
                    THEN 'CF PUE'
                WHEN FI_TransferFactura.CvTipoDocFacturacion = 2
                    THEN 'PI'
                WHEN FI_TransferFactura.CvTipoDocFacturacion = 3
                    THEN 'PE'
                WHEN FI_TransferFactura.CvTipoDocFacturacion = 6
                    THEN 'CF-P'
                WHEN FI_TransferFactura.CvTipoDocFacturacion = 1
                     AND FI_Transfer.IdFormaPago = 2
            ...
            JOIN
                PV_CuentaBancaria (NOLOCK)
                    ON FI_Transfer.IdCuentaDestino = PV_CuentaBancaria.DatoBancarioID
                       AND FI_Transfer.IdContrato = @IdContrato
            JOIN
                PV_CuentaBancaria  PV_CuentaBancariaDestino (NOLOCK)
        ...
        WHERE
            ...
            AND FI_TransferFactura.IdTransfer IS NOT NULL
        ORDER BY
            FI_Transfer.IdTransferencia DESC;
    END;
