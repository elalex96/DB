...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'EN_SHELL_ObtenerDocumentosEntregablesDescarga'
)
    DROP PROCEDURE EN_SHELL_ObtenerDocumentosEntregablesDescarga;
GO

/****** Object:  StoredProcedure [dbo].[EN_SHELL_ObtenerDocumentosEntregables]    Script Date: 09/11/2022 08:31:20 p. m. ******/
SET ANSI_NULLS ON
GO
