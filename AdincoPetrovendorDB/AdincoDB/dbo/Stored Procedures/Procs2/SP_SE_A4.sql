...
AS
     BEGIN
         ...
         SELECT CAST(ISNULL(D.SueldosSalarios, 0) AS DECIMAL(20, 2)) AS SueldosSalarios, 
                CAST(ISNULL(D.SueldosSalariosNacional, 0) AS DECIMAL(20, 2)) AS SueldosSalariosNacional, 
                GR.IdGastoRubro
         FROM #DATOS D
