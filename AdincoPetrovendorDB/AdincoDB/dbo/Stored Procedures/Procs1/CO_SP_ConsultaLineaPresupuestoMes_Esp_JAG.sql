...
-- =============================================
CREATE  PROCEDURE [dbo].[CO_SP_ConsultaLineaPresupuestoMes_Esp_JAG] 
...
AS
     BEGIN
         ...
         -- Insert statements for procedure here
				...
				SELECT P.Nombre,   dbo.CO_LineaPresupuestoMes.IdLineaPresupuestoMes,
...
join co_presupuesto P on P.idpresupuesto = co_lineaPresupuestoMes .idpresupuesto
        -- WHERE(dbo.CO_LineaPresupuestoMes.IdPresupuesto = @presupuesto) --and MONTH 
where co_servicio.idcontrato in (10014,
10015,
10016,
10017,
10018,
...
10023,
10024)
--( CO_LineaPresupuestoMes.AC_FEC_INI ) = @mes 
         GROUP BY P.nombre, dbo.CO_LineaPresupuestoMes.IdLineaPresupuestoMes,
