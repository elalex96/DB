CREATE PROCEDURE [dbo].[EN_EntregablesElaboradosUsuario] --10061,3
    @idUsuario INT,
    @idContrato INT
AS
BEGIN
...
-- =============================================
	...
	IF (@idContrato = 10112 AND @idUsuario = 10437)
	BEGIN
		EXEC EN_EntregablesElaboradosUsuario_ShellHistorico @idUsuario, @idContrato
		RETURN
	END
