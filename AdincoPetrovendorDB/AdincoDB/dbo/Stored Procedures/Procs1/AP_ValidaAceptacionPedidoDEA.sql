USE [Petrovendor]
GO
/****** Object:  StoredProcedure [dbo].[AP_ValidaAceptacionPedidoDEA]    Script Date: 16/07/2021 09:49:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AP_ValidaAceptacionPedidoDEA] 
...
BEGIN
 ...
 --   set @nombreProveedor = (SELECT TOP 1 p.RazonSocial
...
--BUSQUEDA DEL RFC DE LA OPERADORA QUE REALIZA LA ACEPTACION
...
--VERIFICACION DEA
	IF ISNULL(@RFC_ACTUAL,'')  = 'DDE151002QY9' --Wintershall Dea Mexico S. de R.L. de C.V.
	BEGIN
		SELECT 1 AS ISDEA
	END
	ELSE
