CREATE PROCEDURE [dbo].[SIPAC_RC_CONT_21_M_MG] 
-- [SIPAC_RC_CONT_21_M_Test] 10011,'2019-04-01',1
             ...
             BEGIN
                 ...
                 (
                     SELECT LTRIM(RTRIM(CON.IDSIPAC)) AS [RF_00], 
                            ...
                            LTRIM(RTRIM(APCNH.DescripcionActividadPetrolera)) AS [RC21_10], 
                            LTRIM(RTRIM(SP.SubactividadPetrolera)) AS [RC21_11], 
                            LTRIM(RTRIM(TP.TareaPetrolera)) AS [RC21_12],
                     ...
                     GROUP BY LTRIM(RTRIM(CON.IDSIPAC)), 
                              ...
                              LTRIM(RTRIM(SP.SubactividadPetrolera)), 
                     ...
                     SELECT LTRIM(RTRIM(CON.IDSIPAC)) AS [RF_00], 
                            ...
                            END AS [RC21_21], 
                            SUM(CASE
                                    WHEN ISNULL(MP.MontoRegistro, 0) <> 0 --AND NUEVO CAMPO
                                    THEN MP.RC2122
                                    ELSE 0
                                END) AS [RC21_22], 
                            0 AS [RC21_23], 
