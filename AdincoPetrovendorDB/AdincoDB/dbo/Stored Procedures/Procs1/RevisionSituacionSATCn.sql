CREATE proc [dbo].RevisionSituacionSATCn (@preferenciasCN PreferenciaListaNegra readonly)
AS
BEGIN
    ...
    BEGIN TRY
        ...
        FROM @preferenciasCN proveedores
            INNER JOIN ListaNegra
                ON proveedores.Proveedor = ListaNegra.RFC
        ...
        BEGIN
            ...
            SELECT @CorreoNotificacion = CuentaRegistro
            FROM TA_CorreoServidor
