...
-- =============================================
CREATE PROCEDURE [dbo].[CO_ReporteDatosNominacionMensualWord]
...
@FechaMesAnio nvarchar(Max)
                ...
                --Exec [CO_ReporteDatosNominacionMensualWord] 3,1000,1014,'2018-02-01'
AS
BEGIN
                               ...
                               --verifica si ya fue insertado
                                               if(@diasCalendario=@dias)
                                                                               ...
                                                                               --Que unidad esta insertado
                                                                                                              ...
                                                                                                              Select
                                                                                              Top 1     DATENAME(month,idFecha) as mes , Year(idFecha)as anio,TB.nombre as tipoBase,
                                                                               ...
                                                                               begin
                                                                                                              ...
                                                                                                              Select Top 1        DATENAME(month,idFecha) as mes, Year(idFecha)as anio,
