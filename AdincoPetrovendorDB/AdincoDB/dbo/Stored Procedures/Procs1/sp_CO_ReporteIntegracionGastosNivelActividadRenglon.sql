    ...
    BEGIN
        ...
        INSERT INTO #Presupuesto
                    ...
                    FROM
                        ...
                        JOIN
                            CO_TipoServicio    TS
                                ON TS.IdTipoServicio = L.IdTipoServicio
                        JOIN
                            CO_Servicio        S
                        ...
                        SUM(   CASE
                                   WHEN CO_Registro.CvTipoDocFacturacion = 1
                                       ...
                                       THEN (CASE
                                                 ...
                                                 ELSE
                                                     ISNULL(
                                                               (ISNULL(CO_Registro.MontoRegistro, RM.MontoGasto)
        ...
        FROM
            TempReporteIntegracionGastosNivelActividadRenglon GNAR;
    END;
GO
