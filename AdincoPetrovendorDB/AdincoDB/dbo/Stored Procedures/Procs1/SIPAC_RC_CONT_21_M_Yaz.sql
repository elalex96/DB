CREATE PROCEDURE [dbo].[SIPAC_RC_CONT_21_M_Yaz] 
-- [SIPAC_RC_CONT_21_M_Yaz]10036,'2019-10-01',1
             ...
             BEGIN
                 ...
                 (
                     ...
                     WHERE C.IdContrato = @Contrato
                           ...
                           --AND P.IdProgramaActividad = 10058
                           --AND TTF.UUID = '10F6CC4D-187C-4D09-8D96-4D7F36180FF7'
                     ...
                     WHERE C.IdContrato = @Contrato
                           ...
                           --AND P.IdPresupuesto = @IdPresupuesto
                           --AND P.IdProgramaActividad = 10058
                           --AND TTF.UUIDCP = '10F6CC4D-187C-4D09-8D96-4D7F36180FF7'
                     GROUP BY LTRIM(RTRIM(CON.IDSIPAC)), 
                              LTRIM(RTRIM(C.IDRegFiducidiario)), 
                              C.NumeroContrato, 
                              SUBSTRING(P.IdPresupuestoCNH, 22, 10), 
                     ...
                     --AND P.IdPresupuesto = @IdPresupuesto
                     --AND P.IdProgramaActividad = 10058
                     --AND MP.UUID = '10F6CC4D-187C-4D09-8D96-4D7F36180FF7'
                     GROUP BY LTRIM(RTRIM(CON.IDSIPAC)), 
                              LTRIM(RTRIM(C.IDRegFiducidiario)), 
                              C.NumeroContrato, 
                              SUBSTRING(P.IdPresupuestoCNH, 22, 10), 
