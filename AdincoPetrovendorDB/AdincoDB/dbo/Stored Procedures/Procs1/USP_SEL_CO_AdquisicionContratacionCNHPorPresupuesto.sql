IF EXISTS
    (
        ...
        FROM
            dbo.sysobjects
        WHERE
            name = 'USP_SEL_CO_AdquisicionContratacionCNHPorPresupuesto'
    )
    DROP PROCEDURE USP_SEL_CO_AdquisicionContratacionCNHPorPresupuesto
GO
    ...
    BEGIN
        ...
        CREATE TABLE #TablaDEA
            (
                ...
                RelacionOperadoraProveedor VARCHAR(100),
                Proveedor                  VARCHAR(4000),
                MecanismoContratacion      VARCHAR(200),
                [Nombre Contrato C-P]      VARCHAR(4000),
                [No. Contrato]             VARCHAR(4000),
                [Fecha Inicio Contrato]    DATETIME,
                [Fecha Termino Contrato]   DATETIME,
                [Vigencia del contrato]    DATETIME,
                [Objeto del contrato]      VARCHAR(4000),
                MontoUSD                   FLOAT,
                MontoMXN                   FLOAT,
                TipoCambio                 FLOAT,
                FechaTipoCambio            DATETIME,
                Comentarios                VARCHAR(4000),
                NombreContratista          VARCHAR(4000),
                FechaEfectiva              VARCHAR(10)
            );
        ...
        CREATE TABLE #Tabla
            (
                ...
                [No. Contrato]             VARCHAR(4000),
                [Fecha Inicio Contrato]    VARCHAR(4000),
                [Fecha Termino Contrato]   VARCHAR(4000),
                [Vigencia del contrato]    VARCHAR(4000),
                [Objeto del contrato]      VARCHAR(8000),
                MontoUSD                   FLOAT,
                MontoMXN                   FLOAT,
                TipoCambio                 VARCHAR(4000),
                FechaTipoCambio            VARCHAR(4000),
        ...
        SELECT
            ...
            @ContratistaRazonSocialDelContrato = CO_Contratista.RazonSocial,
                    ...
                    (
                        ...
                        FechaEfectiva
                            ...
                            SELECT
                                ...
                                UPPER(@ContratistaRazonSocialDelContrato)                                             AS NombreContratista,
                                ''                                                                                    AS FechaEfectiva
                            FROM
                    ...
                    (
                        ...
                        FechaEfectiva
                            ...
                            SELECT
                                ...
                                NombreContratista                                                                    = UPPER(@ContratistaRazonSocialDelContrato),
                         ...
                         (
                             ...
                             FechaEfectiva      --
                                 ...
                                 SELECT
                                         ...
                                         @ContratistaRazonSocialDelContrato,
                                 ...
                                 SELECT
                                     ...
                                     CASE
                                         ...
                                         ELSE
                                             'NO'
                                     END                                                                        AS RelacionOperadoraProveedor,
                                     UPPER(S_Proveedor.RazonSocial) + ' '
                                     + ISNULL(UPPER(S_Proveedor.RegimenCapital), '')                            AS Proveedor,
                                     'ADJUDICACIÓN DIRECTA'                                                     AS MecanismoContratacion,
                                     UPPER(ISNULL(TA_Operacion.Descripcion, ''))                                AS 'Nombre Contrato C-P',
                                     UPPER(CONCAT(MM_Pedidos.IdPedido, ' CD'))                                  AS 'No. Contrato',
                                     CASE
                         ...
                         (
                             ...
                             FechaEfectiva
                                 ...
                                 SELECT
                                     ...
                                     NombreContratista                               = UPPER(@ContratistaRazonSocialDelContrato), --DWONG 20190712     
