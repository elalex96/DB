...
CREATE PROC dbo.p_InsUpdCromatografiaImportacion
	...
	@VolumenContratistaPetroleo FLOAT=0,
	@VolumenEstadoPetroleo FLOAT=0,
	@VolumenContratistaCondensado FLOAT=0,
	@VolumenEstadoCondensado FLOAT=0
AS
    BEGIN
        SET NOCOUNT ON;
                    ...
                    (
						...
						VolumenEstado
                            ...
                            SELECT
								...
								END,
								CASE WHEN @IdTipoHidrocarburo = 1001 
										THEN isnull(@VolumenContratistaPetroleo,0)  --petroleo
								WHEN @IdTipoHidrocarburo = 1002 
									THEN ISNULL(@VolumenContratistaCondensado,0)  --CONDENSADO
								END,
								CASE WHEN @IdTipoHidrocarburo = 1001 
									THEN isnull(@VolumenEstadoPetroleo,0)  --petroleo
								WHEN @IdTipoHidrocarburo = 1002 
									THEN ISNULL(@VolumenEstadoCondensado,0)  --CONDENSADO
								END
