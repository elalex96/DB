...
SELECT
    @MesInicio = CASE
                     WHEN MONTH(@Mes) = 1
                          OR MONTH(@Mes) = 2
                         THEN DATEFROMPARTS(YEAR(@Mes), 1, 1)
                     WHEN MONTH(@Mes) = 3
                          OR MONTH(@Mes) = 4
                         THEN DATEFROMPARTS(YEAR(@Mes), 3, 1)
                     WHEN MONTH(@Mes) = 5
                          OR MONTH(@Mes) = 6
                         THEN DATEFROMPARTS(YEAR(@Mes), 5, 1)
                     WHEN MONTH(@Mes) = 7
                          OR MONTH(@Mes) = 8
                         THEN DATEFROMPARTS(YEAR(@Mes), 7, 1)
                     WHEN MONTH(@Mes) = 9
                          OR MONTH(@Mes) = 10
                         THEN DATEFROMPARTS(YEAR(@Mes), 9, 1)
                     WHEN MONTH(@Mes) = 11
                          OR MONTH(@Mes) = 12
                         THEN DATEFROMPARTS(YEAR(@Mes), 11, 1)
                 END;
