...
-- Description:	extrae informacion oara el historial de pagos de un mes en especifico
-- =============================================
CREATE PROCEDURE CO_PagosPropietariosPorMes --3,'2018-06-16',2
    @Contrato INT,
    @MES DATE,
    @idUsuario INT
AS
BEGIN
    ...
    WHERE IdContrato IN (
          ...
          AND MONTH(MesPago) = MONTH(@MES)
          AND YEAR(MesPago) = YEAR(@MES);
END;