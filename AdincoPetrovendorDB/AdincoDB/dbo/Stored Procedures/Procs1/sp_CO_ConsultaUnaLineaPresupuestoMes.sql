CREATE PROCEDURE [dbo].[sp_CO_ConsultaUnaLineaPresupuestoMes] 
	@IdLinea INT
AS
BEGIN
    -- =============================================
	...
	-- Fecha Modificación:	08 de Septiembre del 2022
	-- Descripción:			Se agrega condicion de si es < 0 el porcentaje muestre por defecto 0
	-- ========================================================================
    SET NOCOUNT ON;
    -- =============================================
    ...
    FROM dbo.CO_LineaPresupuestoMes
        ...
        LEFT OUTER JOIN CO_TipoCambioMensual
    ...
    WHERE (dbo.CO_LineaPresupuestoMes.IdLineaPresupuestoMes = @IdLinea) 
