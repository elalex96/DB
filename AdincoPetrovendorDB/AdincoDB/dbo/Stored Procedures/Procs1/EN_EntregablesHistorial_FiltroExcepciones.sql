CREATE  PROCEDURE [dbo].[EN_EntregablesHistorial_FiltroExcepciones]--10061,3,0,1
    @idUsuario INT,  
    @idContrato INT,  
    @BitPantallaArea INT   
AS  
...
-- Description: Se reutiliza el sp EN_EntregablesHistorial para generar esta consulta que solo retorna instancias en elaboración y activas
-- =============================================  
    ...
    BEGIN  
		...
		JOIN 
			...
			AND A.EstadoID=@EstatusEnAprobacion
		JOIN 
			EN_ContratoEntregable CE  
			ON I.IdContratoEntregable = CE.IdContratoEntregable  
		INNER JOIN 
