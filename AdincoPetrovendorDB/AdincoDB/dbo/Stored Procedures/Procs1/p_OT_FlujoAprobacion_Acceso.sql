    ...
    BEGIN
        ...
        SELECT
            CreadorOT            = CAST(ISNULL(MAX(   CASE
                                                          WHEN AP_FlujoAprobacionEstatus.Orden = 1
                                                              THEN 1
                                                          ELSE
                                                              0
                                                      END
            ...
            AprobadorOT          = CAST(ISNULL(MAX(   CASE
                                                          WHEN AP_FlujoAprobacionEstatus.Orden = 2
                                                              THEN 1
                                                          ELSE
                                                              0
                                                      END
            ...
            ValidadorCantOT      = CAST(ISNULL(MAX(   CASE
                                                          WHEN AP_FlujoAprobacionEstatus.Orden = 3
                                                              THEN 1
                                                          ELSE
                                                              0
                                                      END
            ...
            GeneradorEstimacion  = CAST(ISNULL(MAX(   CASE
                                                          WHEN AP_FlujoAprobacionEstatus.Orden = 4
                                                              THEN 1
                                                          ELSE
                                                              0
                                                      END
            ...
            AceptacionServicioOT = CAST(ISNULL(MAX(   CASE
                                                          WHEN AP_FlujoAprobacionEstatus.Orden = 5
                                                              THEN 1
                                                          ELSE
                                                              0
                                                      END
            ...
            AdminContratos       = CAST(ISNULL(MAX(   CASE
                                                          WHEN AP_FlujoAprobacionEstatus.Orden = 6
                                                              THEN 1
                                                          ELSE
                                                              0
                                                      END
            ...
            ConsultaContratos    = CAST(ISNULL(MAX(   CASE
                                                          WHEN AP_FlujoAprobacionEstatus.Orden = 7
                                                              THEN 1
                                                          ELSE
                                                              0
                                                      END
        ...
        FROM
            AP_FlujoAprobacionEstatus (NOLOCK)
            INNER JOIN
                ...
                AP_UsuarioCentroCosto (NOLOCK)
                    ON AP_FlujoAprobacionEstatusUsuarios.usuarioId = AP_UsuarioCentroCosto.IdUsuario
                       AND ISNULL(@idCC, 0) in (
                                                   0, AP_UsuarioCentroCosto.IdCentroCosto
                                               )
        WHERE
            AP_FlujoAprobacionEstatus.TipoFlujoAprobacionId = @pTipoFlujoAprobacionId
