...
BEGIN
	...
	INSERT INTO CO_RegistroMarkupBitacora(IdRegistro, IdEstadoAnterior,IdEstadoActual, MesEstadoPemexAnterior, MesEstadoPemexActual, CreadoPor, CreadoEn )
	SELECT @IdRegistro, IdEstadoPemex, @IdEstado, MesEstadoPemex, @MesEstadoPemex, @IdUsuario, GETDATE()
