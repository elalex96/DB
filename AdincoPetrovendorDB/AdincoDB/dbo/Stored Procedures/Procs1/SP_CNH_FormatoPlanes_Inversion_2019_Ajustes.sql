...
-- =============================================
CREATE PROCEDURE [dbo].[SP_CNH_FormatoPlanes_Inversion_2019_Ajustes]
--exec[SP_CNH_FormatoPlanes_Inversion_2019_Ajustes] 10036,1,'2019-11-01',10058
--exec[SP_CNH_FormatoPlanes_Inversion_2019_Ajustes] 10036,1,'2019-11-01',10100
...
DROP TABLE #RESULTADO;*/
         ...
         /*HOJA 21 CGI para que den el mismo resultado hasta Noviembre 2019*/
             ...
             BEGIN
                 ...
                 (
                     ...
                     FROM dbo.FI_Transfer T
                          ...
                          JOIN dbo.CO_Contrato C ON T.IdContrato = C.IdContrato
                 ...
                 (IdTipoProgramaActividad, 
                  ...
                  MesPresentacionOrig
                        ...
                        SELECT TPA.IdTipoProgramaActividad, 
                               ...
                               H21.RC21_02, 
                               H21.MesPresentacion
                        FROM #Hoja21_CGIantes H21
                             JOIN dbo.CO_ActividadPetroleraCNH AP ON AP.id_Actividad = H21.RC21_10
                             JOIN dbo.CO_SubactividadPetrolera SAP ON SAP.[id_Sub-actividad] = H21.RC21_11
                             JOIN dbo.CO_TareaPetrolera TP ON TP.id_Tarea = H21.RC21_12
                             JOIN dbo.CO_Servicio S ON S.IdServicio = H21.IdServicio
                             JOIN dbo.CO_ProgramaActividad PA ON H21.IdProgramaActividad = PA.IdProgramaActividad
                             JOIN dbo.CO_TipoProgramaActividad TPA ON TPA.IdTipoProgramaActividad = PA.IdTipoProgramaActividad
                             JOIN dbo.CO_ActSubTareaPetroleraCNH ASTP ON AP.IdActividadPetrolera = ASTP.IdActividadPetrolera
         ...
         SELECT UPPER(dbo.RemoverAcentos(TPA.TipoPrograma)) AS TipoPrograma, 
             ...
             INTO #tmpResultFinal
         FROM #RESULTADO R
              JOIN dbo.CO_ActividadPetroleraCNH AP ON AP.IdActividadPetrolera = R.IdActividadPetrolera
              JOIN dbo.CO_SubactividadPetrolera SAP ON SAP.IdSubactividadPetrolera = R.IdSubactividadPetrolera
              JOIN dbo.CO_TareaPetrolera TP ON TP.IdTareaPetrolera = R.IdTareaPetrolera
              JOIN dbo.CO_Servicio S ON S.IdServicio = R.IdServicio
              JOIN dbo.CO_TipoProgramaActividad TPA ON TPA.IdTipoProgramaActividad = R.IdTipoProgramaActividad
              JOIN dbo.CO_ActSubTareaPetroleraCNH ASTP ON AP.IdActividadPetrolera = ASTP.IdActividadPetrolera
                                                          AND SAP.IdSubactividadPetrolera = ASTP.IdSubactividadPetrolera
                                                          AND TP.IdTareaPetrolera = ASTP.IdTareaPetrolera
