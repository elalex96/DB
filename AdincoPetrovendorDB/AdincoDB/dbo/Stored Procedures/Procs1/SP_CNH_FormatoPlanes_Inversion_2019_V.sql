...
-- =============================================
CREATE PROCEDURE [dbo].[SP_CNH_FormatoPlanes_Inversion_2019_V]
--exec[SP_CNH_FormatoPlanes_Inversion_2019_V] 10036,1,'2019-12-01',10058
--exec[SP_CNH_FormatoPlanes_Inversion_2019_V] 10036,1,'2019-12-01',10100
         ...
         (IdFacturaCP, 
          ...
          IdRegistro
                ...
                FROM dbo.FI_Transfer T WITH(NOLOCK)
                     ...
                     JOIN #Facturas WITH(NOLOCK) ON #Facturas.IdFactura = FCPDR.IdFactura
         ...
         (IdRegistro, 
          ...
          IdMoneda
                ...
                SELECT MCF.IdRegistro, 
                       ...
                       TCD.Fecha, 
                       MCF.IdMoneda
                FROM #Facturas MCF WITH(NOLOCK)
                     JOIN dbo.FI_TransferFactura TF WITH(NOLOCK) ON TF.IdFactura = MCF.Idfactura
