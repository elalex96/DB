CREATE PROCEDURE [dbo].[BTU_PC_VistaComparativa]--3,'20190801'
    @idContrato INT,
...
BEGIN
	...
	DECLARE @TieneArchivo53 INT;

	SELECT @TieneArchivo53=COUNT(1) FROM PC_ExcelPemex WHERE IdTipoExcelPemex = 10005 AND IdContrato=@idContrato AND FechaReporte=@fechaMesDiaAnio;
    ...
    SELECT
		...
		CASE 
		WHEN @TieneArchivo53>=1
		THEN 1 --'SI'
		ELSE
       0-- 'NO'
		END AS TieneArchivo53
