...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'SP_MM_DescargaArchivosSoporteProcura'
)
    DROP PROCEDURE SP_MM_DescargaArchivosSoporteProcura;
GO
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[SP_MM_DescargaArchivosSoporteProcura] --'2023-02-01','2023-02-28',10038,21
