...
CREATE  PROCEDURE[dbo].[SP_AD_S3_MM_DocSoporteRecepcionFactura] 
...
BEGIN				
		...
		BEGIN
		  ...
		  SELECT TOP 50 IdDocSoporteRecepcionFactura,		        
		  		 ISNULL(NombreDoc,(CONCAT('Documento',IdDocSoporteRecepcionFactura)))
		  FROM dbo.MM_DocSoporteRecepcionFactura
		  WHERE Identificador IS NULL 
		  ORDER BY IdDocSoporteRecepcionFactura ASC		   
