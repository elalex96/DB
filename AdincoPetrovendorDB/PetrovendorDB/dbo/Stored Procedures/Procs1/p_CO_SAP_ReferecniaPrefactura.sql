...
create proc p_CO_SAP_ReferecniaPrefactura
@pIdContrato int,
@pIdProveedor int
as
	...
	select IdPRESES,Referencia = SAPSESNUmber,Monto= CONVERT(varchar, CAST(MontoTotalPrefactura AS money), 1)
