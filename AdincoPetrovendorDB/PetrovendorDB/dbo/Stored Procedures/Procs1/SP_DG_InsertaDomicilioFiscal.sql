...
-- Description:	INSERTAR DOMICILIO FISCAL , MATRIZ O SUCURSAL
-- =============================================
CREATE PROCEDURE [dbo].[SP_DG_InsertaDomicilioFiscal]
...
BEGIN
	...
	insert into DG_Domicilio ( IdPais, 
	Estado,
	Municipio,
	Colonia, 
	TipoViabilidad, 
