...
-- p_MPY_SESAceptacion 3,1000002089,20,4500002258,10
...
as
	...
	from  MPY_MM_AceptacionPedido aprov
		...
		rtrim(aprov.ServiceLineNumber) COLLATE SQL_Latin1_General_CP1_CI_AS = rtrim(ses.SESNumber) COLLATE SQL_Latin1_General_CP1_CI_AS
