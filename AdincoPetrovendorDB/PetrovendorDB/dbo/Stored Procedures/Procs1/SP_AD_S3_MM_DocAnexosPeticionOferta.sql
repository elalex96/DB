...
CREATE PROCEDURE[dbo].[SP_AD_S3_MM_DocAnexosPeticionOferta] 
...
BEGIN				
		...
		BEGIN
		  ...
		  SELECT TOP 50 IdDocAnexoPeticionOferta,		        
		  		 ISNULL(NomDocumento,(CONCAT('Documento',IdDocAnexoPeticionOferta)))
		  FROM dbo.MM_DocAnexosPeticionOferta
		  WHERE Identificador IS NULL 
		  ORDER BY IdDocAnexoPeticionOferta ASC		   
