...
-- =============================================  
CREATE  PROCEDURE [dbo].[p_MPY_FI_InsertaFacturaMercadeoNotaCredito]   
 @Serie nvarchar(MAX) ,  
 @Folio nvarchar(MAX) ,  
 @Fecha datetime ,  
 @Sello nvarchar(MAX) ,  
...
IF @IdContrato = 0   
 BEGIN    
 SET @IdContratoF = (SELECT IDCONTRATO FROM MPY_MM_AceptacionPedido WHERE IdAceptacionPedido = @IdAceptacionPedido)  
 END   
ELSE   
BEGIN  
