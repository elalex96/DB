...
-- =============================================
CREATE  PROCEDURE [dbo].[SP_DEA_GetDocumentoPRExterno]
@IdProveedor INT,
@IdUsuario INT,
@IdDocumento INT,
...
BEGIN
	...
	SELECT D.NombreDocumento,D.Extension,D.Mime,D.Carpeta,D.Identificador,PR.IdSolicitudPedido,PR.ID_PR,D.Bucket
