...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'Mobile_EnviarNotificacionAprobacionPedido'
)
    DROP PROCEDURE Mobile_EnviarNotificacionAprobacionPedido;
GO 
/****** Object:  StoredProcedure [dbo].[Mobile_EnviarNotificacionAprobacionPedido]    Script Date: 15/02/2022 10:19:30 p. m. ******/
SET ANSI_NULLS ON
GO
