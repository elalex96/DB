...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'CP_SP_ValidarUUIDFactura'
)
    DROP PROCEDURE CP_SP_ValidarUUIDFactura; 
GO
/****** Object:  StoredProcedure [dbo].[CP_SP_ValidarUUIDFactura]    Script Date: 11/01/2023 11:32:20 a. m. ******/
SET ANSI_NULLS ON
GO
