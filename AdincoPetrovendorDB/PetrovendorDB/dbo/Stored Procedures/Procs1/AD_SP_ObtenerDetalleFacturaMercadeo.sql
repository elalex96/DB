...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'AD_SP_ObtenerDetalleFacturaMercadeo'
)
    DROP PROCEDURE AD_SP_ObtenerDetalleFacturaMercadeo;
GO 
/****** Object:  StoredProcedure [dbo].[AD_SP_ObtenerDetalleFacturaMercadeo]    Script Date: 10/03/2021 05:58:03 p. m. ******/
SET ANSI_NULLS ON
GO
