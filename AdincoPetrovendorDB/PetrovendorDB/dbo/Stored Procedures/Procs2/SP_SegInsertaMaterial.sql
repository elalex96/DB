...
BEGIN
	...
	BEGIN
	SET @IdMaterialNuevo = 0
	END

	--IF @SubFamilia ='Servicio' 
	--	BEGIN
	--		SET  @SubFamilia = 'Temporal SubFamilia'
	--	END

	--IF @Familia ='Servicio' 
	--	BEGIN
	--		SET  @Familia = 'Temporal Familia'
	--	END
	...
	INNER JOIN PV_MM_MaterialSubFamilia AS MSF ON MSF.IdSubFamilia = GFDUT.IdSubFamilia
	INNER JOIN PV_MM_MaterialFamilia AS MF ON MF.IdFamilia = GFDUT.IdFamilia
	INNER JOIN MM_Maestro AS MM ON MM.IdSubfamilia =  GFDUT.IdSubFamilia
