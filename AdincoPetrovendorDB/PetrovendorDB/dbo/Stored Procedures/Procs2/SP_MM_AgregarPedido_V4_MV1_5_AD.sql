...
-- Description: Agregue validación si IdFlujo=0 o null volver a buscar el predeterminado
-- =============================================
-- Author:		Pedro Acuña
...
BEGIN
    ...
    ----INSERT INTO MM_Pedido(IdSolicitudPedido, IdSubcontratista, CreadoEl, CreadoPor, Activo, IdDomicilioEntrega)
    ...
    BEGIN
        ...
        --#Obtener el IdMoneda del proveedor actual
        ...
        EXEC dbo.SP_MM_GenerarIdPedidoGeneral @IdTipoPedido = 4,                        -- int 4 = Adjudicación Directa --> MM_TipoPedido
        ...
        VALUES
        (@IdSolicitudPedido, @IdTipoOperacion, @IdFlujo, 1, 1, @IdProveedorCompras, @IdUsuarioCompras, GETDATE(),
         @Mensaje, @IdVigencia, @IdPrioridad, @VERSION);


        SET @IdOperacionActual =
        (
            SELECT SCOPE_IDENTITY()
        );
        ...
        SET POD.AddPedidoTemp = 0,
			...
			POD.IdCondicionPagoTemp=NULL,
			POD.DiasCreditoTemp=NULL 
        ...
        BEGIN
            ...
            --Insertar la justificacion

            EXEC dbo.SP_MM_AgregarJustificacion @IdPedido = @IdPedidoActual,     -- int
                                                ...
                                                @FechaRegistro = '20180101';     -- datetime
