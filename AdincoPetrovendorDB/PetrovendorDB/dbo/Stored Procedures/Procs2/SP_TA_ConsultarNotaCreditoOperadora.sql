...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'SP_TA_ConsultarNotaCreditoOperadora'
)
    DROP PROCEDURE SP_TA_ConsultarNotaCreditoOperadora;
GO
/****** Object:  StoredProcedure [dbo].[SP_TA_ConsultarNotaCreditoOperadora]    Script Date: 26/04/2022 05:16:05 p. m. ******/
SET ANSI_NULLS ON
GO
