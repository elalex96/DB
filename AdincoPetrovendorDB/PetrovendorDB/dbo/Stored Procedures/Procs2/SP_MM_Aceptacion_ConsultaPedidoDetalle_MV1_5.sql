...
-- =============================================  
CREATE PROCEDURE [dbo].[SP_MM_Aceptacion_ConsultaPedidoDetalle_MV1_5] --22521,1835
...
AS  
     BEGIN
          ...
          FROM dbo.MM_Pedido AS P WITH (NOLOCK)
              ...
              LEFT JOIN dbo.MM_AceptacionPedido AP WITH (NOLOCK) ON AP.IdPedido=P.IdPedido AND ISNULL(AP.IdEstatusEliminado,0)<>1 --> QUE LA ACEPTACIÓN NO ESTE ELIMINADA  
