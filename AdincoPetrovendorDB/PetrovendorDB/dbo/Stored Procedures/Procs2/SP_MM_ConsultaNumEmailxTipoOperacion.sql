...
-- Description:	
-- =============================================
CREATE PROCEDURE [dbo].[SP_MM_ConsultaNumEmailxTipoOperacion]
...
BEGIN
	...
	SELECT  O.IdOperacion, count(O.NombreOperacion) AS numEmailSinVer, O.NombreOperacion FROM TATAREA AS T
	...
	GROUP BY O.NombreOperacion, O.IdOperacion
