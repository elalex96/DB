...
BEGIN
    ...
    -- Insert statements for procedure here
	 ...
	 INNER JOIN MM_AceptacionCartaPCN AS AC_PCN ON AC_PCN.IdDocumento = D.IdDocumento
	 INNER JOIN MM_AceptacionPedido AS AP ON AP.IdAceptacionPedido = AC_PCN.IdAceptacionPedido
