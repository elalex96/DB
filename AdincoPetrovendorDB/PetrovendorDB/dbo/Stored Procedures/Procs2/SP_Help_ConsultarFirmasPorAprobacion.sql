...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'SP_Help_ConsultarFirmasPorAprobacion'
)
DROP PROCEDURE SP_Help_ConsultarFirmasPorAprobacion;
GO
/****** Object:  StoredProcedure [dbo].[SP_PR_MM_ConsultaAprobadoresSolicitudPedido]    Script Date: 26/08/2022 12:40:03 p. m. ******/
SET ANSI_NULLS ON
GO
