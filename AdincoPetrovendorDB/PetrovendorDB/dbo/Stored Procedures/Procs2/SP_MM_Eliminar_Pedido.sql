...
BEGIN TRY
 ...
 --   DECLARE @IDPROVEEDOR INT=420
	...
	*/
	...
	DECLARE @DISPONIBLE_ELIMINACION INT =(SELECT COUNT(IdPedido) FROM MM_Pedido WHERE IdPedido = @IDPEDIDO AND IdProveedorCompras=@IDPROVEEDOR AND ISNULL(IdEstatusEliminado,0)=0)
