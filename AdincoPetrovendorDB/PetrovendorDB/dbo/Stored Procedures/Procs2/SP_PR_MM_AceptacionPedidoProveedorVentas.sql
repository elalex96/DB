...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'SP_PR_MM_AceptacionPedidoProveedorVentas'
)
    DROP PROCEDURE SP_PR_MM_AceptacionPedidoProveedorVentas;
GO
/****** Object:  StoredProcedure [dbo].[SP_PR_MM_AceptacionPedidoProveedorVentas]    Script Date: 16/06/2022 05:27:48 p. m. ******/
SET ANSI_NULLS ON
GO
