...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'WDEA_GuardarWBSLineaPresupuesto'
)
    DROP PROCEDURE WDEA_GuardarWBSLineaPresupuesto;
/****** Object:  StoredProcedure [dbo].[WDEA_GuardarWBSLineaPresupuesto]    Script Date: 04/10/2022 11:37:38 a. m. ******/
SET ANSI_NULLS ON
GO
