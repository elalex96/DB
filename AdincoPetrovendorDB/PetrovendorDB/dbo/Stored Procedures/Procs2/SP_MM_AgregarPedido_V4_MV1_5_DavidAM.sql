...
-- Description:	Permite agregar PEDIDO  y PEDIDO DETALLE
-- =============================================
-- Author:		Pedro Acuña
...
-- Description:	Se agrega el guardado del bit NoCartaCN, Carta de CN a demanda
-- Create date: 15-10-2018
-- Description:	Se agrega funcionalidad para aprobacion movil
-- =============================================

create PROCEDURE [dbo].[SP_MM_AgregarPedido_V4_MV1_5_DavidAM]
...
BEGIN
    ...
    BEGIN
        ...
        SELECT @IdOperacionActual = @@IDENTITY;
