...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'SP_MM_ConsultaMaterialAceptacionDetalle_MV1_5'
)
    DROP PROCEDURE SP_MM_ConsultaMaterialAceptacionDetalle_MV1_5;
GO 

/****** Object:  StoredProcedure [dbo].[SP_MM_ConsultaMaterialAceptacionDetalle_MV1_5]    Script Date: 21/04/2021 10:59:07 ******/
SET ANSI_NULLS ON
GO
