...
-- =============================================
CREATE  PROCEDURE  [dbo].[SP_TA_ConsultarFlujoPedidoPedidoAprobadores] 
...
BEGIN
	...
	WHERE OPE.IdTipoOperacion=7 AND (FT.Eliminado =  0 OR FT.Eliminado IS NULL) AND FT.IdProveedor= @IdProveedor  ---420
	AND FT.[IdFlujoTarea] = @IdFlujoAprobacion---1168 
