...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'SRAP_ConsultarDocumentosAnexos'
)
    DROP PROCEDURE SRAP_ConsultarDocumentosAnexos;

/****** Object:  StoredProcedure [dbo].[SP_PR_MM_PCN_AceptacionProveedorDocumentos]    Script Date: 18/06/2021 12:56:48 p. m. ******/
SET ANSI_NULLS ON
GO
