...
(
    SELECT 1
    FROM dbo.sysobjects
    WHERE name = 'SP_DEA_PlantillaFacturaAprobadaProveedor'
)
    DROP PROCEDURE SP_DEA_PlantillaFacturaAprobadaProveedor;
GO
-- =============================================  
-- Author:  Daniel Cruz  
         ...
         <td align="center">
            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td>
                        <table width="100%" bgcolor="#5e5f5e" cellspacing="0" cellpadding="0" align="center"                                      class="full" style="border-radius: 6px 6px 0 0;">
                           <tbody>
                              <tr>
                                 <td height="3"></td>
                              </tr>
                              <tr>
                                 <td>
                                    <table border="0" align="left" class="inner"                                                      style="border-collapse: collapse;">
                                       <tbody>
                                          <tr>
                                             <td height="45" class="inner" valign="middle"> <a> <img                                                                          style="padding-left:2em" class="logo"                                                                          src="https://procura.adinco.mx/assets/logoSMPS.png"                                                                          width="150" height="22" alt="" /> </a> </td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </td>
         ...
         <td align="center">
            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td>
                        <table width="100%" bgcolor="#5e5f5e" cellspacing="0" cellpadding="0" align="center"                                      class="full" style="border-radius: 0 0 6px 6px;">
                           <tbody>
                              <tr>
                                 <td height="18"></td>
                              </tr>
