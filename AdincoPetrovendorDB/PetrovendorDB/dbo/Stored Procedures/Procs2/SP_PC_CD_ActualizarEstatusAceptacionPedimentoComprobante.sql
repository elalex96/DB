...
-- =============================================
CREATE PROCEDURE [dbo].[SP_PC_CD_ActualizarEstatusAceptacionPedimentoComprobante]
    ...
    BEGIN
        ...
        IF @ESTATUS_TEMPORAL = 'CONTINUAR_APROBACION_GENERAL'
            BEGIN
                ...
                EXEC SP_PC_CD_CambiarEstatusFlujoPeticionComprobante 
                     @IdOperacion;
                ...
                FROM TA_Tarea AS T
                     ...
                     LEFT JOIN dbo.FI_PedimentoComprobante PE ON PE.IdPedimentoComprobante = TOO.IdDocumento
