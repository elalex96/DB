...
-- =============================================
CREATE procedure [dbo].[SP_MPY_PR_MM_PCN_ConsultarCargaFactura]
...
AS
	...
	BEGIN 
	 INSERT INTO MPY_MM_AceptacionFactura (IdAceptacionPedido, CreadoEl,IdEstatus, IdEstatusXML,IdEstatusPDF)
