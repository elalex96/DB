...
-- =============================================
CREATE procedure [dbo].[SP_MPY_MM_PCN_ActualizarPCN_PedidoDetalle]
...
BEGIN
	...
	DECLARE @IdAceptacionPedido INT = (SELECT AP.IdAceptacionPedido
									...
									INNER JOIN MPY_MM_AceptacionPedidoDetalle AS APD ON APD.IdAceptacionPedido =		   AP.IdAceptacionPedido
	...
	DECLARE @TOTAL_MM_PCN INT  = (SELECT COUNT(APD.IdAceptacionPedido)
									...
									INNER JOIN MPY_MM_AceptacionPedido AS AP ON AP.IdAceptacionPedido=					   APD.IdAceptacionPedido
