CREATE VIEW dbo.VistaSATListaNegra
AS
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "ListaNegra (Adinco.dbo)"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 136
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaSATListaNegra';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VistaSATListaNegra';
