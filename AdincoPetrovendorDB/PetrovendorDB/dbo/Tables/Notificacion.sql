CREATE TABLE [dbo].[Notificacion] (
    ...
    CONSTRAINT [PK_Notificacion] PRIMARY KEY CLUSTERED ([IdNotificacion] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON)
);
...
CREATE NONCLUSTERED INDEX [Notificacion_IdProveedor_Activo]
    ...
    INCLUDE([FechaRegistro], [IdOperacion]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
