CREATE TABLE [dbo].[RelacionCartaCNPedido] (
    ...
    PRIMARY KEY CLUSTERED ([IdPedido] ASC, [IdAceptacionPedido] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
GO
CREATE NONCLUSTERED INDEX [CartaAceptacion]
    ON [dbo].[RelacionCartaCNPedido]([IdAceptacionPedido] ASC)
    INCLUDE([PedirCarta]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
