## 1. Lista de verificación para la revisión por pares
- [ ] El código fuente es preciso y completo con respecto a lo solicitado.
- [ ] La documentación del código: es clara y precisa.
- [ ] Los errores inesperados se encuentran controlados y registrados en el sistema de bitácora definido
- [ ] Se realizan únicamente la obtención de datos necesarios 
- [ ] Se respeta la unicidad y estructura de los estándares de codificación definidos en la organización
- [ ] El código controla adecuadamente los errores en tiempo de ejecución comunes como valores negativos no esperados, índices de arreglos y exceso de caracteres en cadenas
- [ ] Si el desarrollo tiene conexiones a sistemas internos o externos (SDK, interacción con Web Services, carga de archivos), verificar si la implementación es acorde a los estándares definidos
